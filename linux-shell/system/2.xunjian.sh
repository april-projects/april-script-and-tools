#!/bin/bash
# @Author: Linux
# @Date:   2022-05-27 09:56:57
# @Last Modified by:   Linux
# @Last Modified time: 2022-05-27 09:56:57
# @E-mail: mobaijun8@163.com
#!/bin/bash
# 主机信息每日巡检
...
echo -e "`date "+%Y-%m-%d %H:%M:%S"` 114服务器巡检报告"  | mail -a $RESULTFILE -s "114服务器巡检报告" mobaijun8@163.com